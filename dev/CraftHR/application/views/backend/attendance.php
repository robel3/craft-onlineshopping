                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value->Hours; ?></td>
                                                 <td><?php if ($value->timesheet_status == 0) {
                                                     ?> 
                                                     <a href="Approve_Attendance?A=<?php echo $value->id; ?>" title="pending" class="btn btn-sm btn-warning waves-effect waves-light" data-value="pending" >Approve</a><br>   
                                                     <?php
                                                 } else{
                                                    ?>
                                                    <input type="submit" value="Approved" disabled title="Approved" class="btn btn-sm fa fa-check btn-info " data-value="Approved" /><br>   
                                                    <?php 
                                                    }?>
