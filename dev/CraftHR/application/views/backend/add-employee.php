                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                     ...
                                     <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="city" class="form-control form-control-line" placeholder="ID"> 
                                    </div>
                                     <div class="form-group col-md-3 m-t-20">
                                        <label>Employee State </label>
                                        <input type="text" name="state" class="form-control form-control-line" placeholder="ID"> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
