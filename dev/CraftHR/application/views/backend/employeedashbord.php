            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Employeee Dashboard</li>
                    </ol>
                </div>
            </div>
            <!-- Container fluid  -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    ?>  Employees</h3>
                                       <a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>">Profile</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>Attendance/Emp_Save_Attendance" class="text-muted m-b-0">Timesheet</a>
                                        </div>
                                </div>
                            </div>
                        </div>
