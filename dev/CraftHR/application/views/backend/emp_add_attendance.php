...
<?php $this->load->view('backend/sidebar'); $id = $this->session->userdata('user_login_id');
                    ...
                    <div class="col-6">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">New Attendance </h4>
                            </div>
                            <div class="card-body">
                                    <form method="post" action="Add_Attendance" id="holidayform" enctype="multipart/form-data">
                                    <div class="modal-body">
			                                    <div class="form-group">
			                                        <label>Employee: <?php echo '('. $basicinfo->first_name.' '.$basicinfo->last_name .')' ; ?></label>
                                                    <input type="text" name="emid" readonly class="form-control" value="<?php echo $basicinfo->em_code; ?>">
