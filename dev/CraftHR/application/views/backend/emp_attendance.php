         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Emp_Save_Attendance" class="text-white"><i class="" aria-hidden="true"></i> Add Attendance </a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Employee Attendance List  </h4>
                            </div>
                            <div class="card-body">
                                           ...
                                           <?php foreach($attendancelist as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $value->Hours; ?></td>
                                                 <td><?php if ($value->timesheet_status == 0) {
                                                     ?> <span class="warning">pending</span> <?php
                                                 } else{
                                                    ?>
