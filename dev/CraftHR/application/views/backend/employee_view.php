                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a> -->
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
                                                     ...
                                                     <div class="form-group col-md-4 m-t-10">
                                                        <label>City </label>
                                                        <input type="text" id="" name="city" class="form-control form-control-line" value="<?php echo $basic->city; ?>" placeholder="Your city" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } ?> minlength="3" required> 
                                                    </div>

                                                     <div class="form-group col-md-4 m-t-10">
                                                        <label>State </label>
                                                        <input type="text" id="" name="state" class="form-control form-control-line" value="<?php echo $basic->state; ?>" placeholder="Your state" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } ?> minlength="3" required> 
                                                    </div>
                                                  <!--   <div class="form-group col-md-4 m-t-10">
                                   ...
                                   <?php if(!empty($basic->em_image)){ ?>
                                    ...
                                    <?php } ?>
                                                    ...
                                                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?><div class="form-actions col-md-12">
                                    ...
                                    <div class="card">
	                                    ...
	                                    <div class="card-body">
			                                <form class="row" action="Add_Education" method="post" enctype="multipart/form-data" id="insert_education">
			                                  ...
			                                  <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?><div class="form-actions col-md-6">
                                                    <input type="hidden" name="emid" value="<?php echo $basic->em_id; ?>">
                                                    <button type="submit" class="btn btn-info"> <i class="fa fa-check"></i> Update</button>
                                                </div>
                                                    <?php } else { ?>
