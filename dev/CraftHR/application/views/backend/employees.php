                                           ...
                                           <?php foreach($employee as $value): ?>
                                            <tr>
                                               ...
                                               <!--  <td class="jsgrid-align-center ">
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?php echo base_url(); ?>employee/Del_employee?I=<?php echo base64_encode($value->em_id); ?>" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
